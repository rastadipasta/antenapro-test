...
export default function ContactPage() {
  return <main id="main-content">
    <section className="inner-hero contact-hero"><div className="inner-hero-media"><Image src="/images/kontakt-hero.png" alt="AntenaPRO tehničar razgovara s klijentom uz satelitsku antenu" fill priority sizes="100vw" /></div><div className="hero-grid" /><div className="shell inner-hero-content"><p className="eyebrow"><span /> Odgovaramo u najkraćem roku</p><h1>Recite nam što<br />trebate riješiti.</h1><p>Pošaljite osnovne informacije o lokaciji i potrebnoj usluzi. Za hitan dogovor nazovite nas izravno.</p><div className="hero-actions"><a className="button button-primary" href="#kontakt-forma">Pošalji upit <span>↓</span></a><a className="button button-ghost" href={contact.phoneHref} aria-label={`Nazovite AntenaPRO na ${contact.phoneLabel}`}><span className="live-dot" /> {contact.phoneLabel}</a></div></div></section>
    <section id="kontakt-forma" className="section contact-section"><div className="shell contact-page-grid">
